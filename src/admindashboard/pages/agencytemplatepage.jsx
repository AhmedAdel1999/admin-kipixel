...
import titktoklogo from "../../assets/client/tiktok-img.png"
    ...
    return(
        <div className="p-6 bg-white rounded-lg flex flex-col gap-4">
            ...
            <div className='w-full flex justify-between py-4' ref={container}>
                <div className="flex flex-col justify-end mb-11 gap-8">
                    <div 
                ...
                <div className="self-stretch flex flex-col justify-end pb-[10px]">
                    <div id="centerItem">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div 
                        className='flex items-center gap-4 border border-[#16F2D1] rounded-lg px-3 py-1 -translate-x-[25%]'
                        id='rigthItem-4'
                    >
                        <div className="grow flex items-center gap-2">
                            <img src={titktoklogo} alt="google-tag-manager-logo" className='w-[35px] h-[35px]' />
                            <span>Tiktok conversion API</span>
                        </div>
                        <p className='flex items-center text-[#16F2D1]'>
                        <Icon icon="octicon:dot-fill-16" fontSize={16} />
                        <span className='font-bold text-sm'>Active</span>
...
export default AgencyTemplatePage;
