    ...
    const billingTableData = [
        {
            ...
            cell5:(
                <div className="flex items-center justify-center rounded-lg h-[22px] w-fit px-2 text-[#fff] bg-[#13B238]">
                    <Icon icon="octicon:dot-fill-16" fontSize={15} />
        ...
        <div className="flex flex-col gap-6">
            <div className="p-6 bg-white rounded-lg flex flex-col gap-10">
                <div className="flex justify-between items-center">
                    <h3 className="capitalize font-[600] text-[24px] text-[#0E1B26]">{agencyName}</h3>
                    <div className="flex gap-4">
                        <Button className="flex gap-2 h-fit !bg-white text-black border py-1.5 m-0">
                            <Icon icon="icon-park:download-two" fontSize={20} />
                            <span className="capitalize font-bold">Export</span>
                        </Button>
