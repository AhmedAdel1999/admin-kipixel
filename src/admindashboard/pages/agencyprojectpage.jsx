  ...
  useEffect(() => {
    ...
    return(
        <div className="p-6 bg-white rounded-lg flex flex-col gap-4">
            <h3 className="font-[600] text-[#0E1B26]">{projectName}</h3>
            <div className='w-full flex justify-between py-4' ref={container}>
                <div className="flex flex-col gap-8">

                <div 
                    className='cursor-pointer flex items-center gap-4 border border-[#16F2D1] rounded-lg px-3 py-1 translate-x-[10%]'
                    id='leftItem-1'
                    onClick={()=>{
                        navigate(`${location.pathname}/google tag manager`)
                    }}
                >
...
export default AgencyProjectPage;